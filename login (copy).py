...
def addProduct(): 
    ...
    submitbtn1 = tk.Button(root, text ="delete",fg = 'red',command= lambda: addProductCommit(root,'delete',productId, productName,  productDescription,productCategory,productPrice))
    submitbtn1.place(x = 300, y = 400, width = 100)
    ...
    submitbtn4.place(x = 200, y = 400, width = 65)
